...
const toFormValues = (resort: Resort): UpdateResortInput => ({
  ...
  img4: resort.img4 || "",
  unitPricing:
    Array.isArray(resort.unitPricing) && resort.unitPricing.length > 0
      ? resort.unitPricing
      : DEFAULT_UNIT_PRICING,
});
  ...
  useEffect(() => {
    ...
    const loadResort = async () => {
      ...
      try {
        ...
        if (!resort) {
          setLoadError(
            "This resort could not be found. It may have been deleted.",
          );
          return;
        }
        ...
        setLoadError(
          error instanceof Error
            ? error.message
            : "Something went wrong loading this resort.",
        );
      } finally {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
        Changes here update the live listing in the resort directory and booking
        flow as soon as they&apos;re saved.
      </p>
